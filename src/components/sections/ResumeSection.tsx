...
import { projects, personalInfo, Project } from "@/src/data/projects";
...
export default function ResumeSection() {
  return (
    <section className="p-10 md:p-16 print:p-[8mm] print:min-h-0 min-h-[297mm] flex flex-col bg-zinc-950">
      <ResumeHeader />

      <div>
        <h2 className="text-[14pt] border-l-4 border-white pl-4 mb-4 uppercase tracking-tighter font-black text-white">Project Summary</h2>
      ...
      <div className="mt-auto pt-16 border-t border-zinc-900/50 flex justify-between items-center text-[7.5pt] text-zinc-700 font-mono no-print">
