---
title: 해커톤 프로젝트 회고(1회차)
date: 2022-08-15 17:08:90
category: like-lion
...
### 어떻게 해결해야할까?
팀 담당 멘토님에게 자문을 구하고, 블로그를 찾아보며 `Thymeleaf`에서 제공하는 `layout`을 새로 알게되어 이를 이용해 **리팩터링**을 진행하였다.

### 1. Fragment를 독립된 파일로 만들기
> 하나의 파일로 이루어져있던 fragment를 용도에 맞는 파일로 나눠주었다.

![](./images/layout-fragment-img.png)
